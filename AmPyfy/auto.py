...
root = Tk()
root.geometry("1700x1040")
root.configure(background = 'black')

history = []

def post():
    from record import export
    export(history)
...
expbutton = Button(root,  text = "EXPORT", activebackground = '#AFAFAF', command= lambda: post(), width=100, height= 10)
expbutton.grid(row = 5, columnspan=5,pady=15, padx=100)
